...
const [Account_Subtype,setAcc_SubType]=useState("USD")
...
function onWithdraw(){
   if( Acc_Number && Acc_Type && Account_Subtype && Amount ){
if(Amount < 20){
  Alert.alert("Sorry","Minimum withdraw is 20 USD.")
}else{
...
function Withdraw (){
  ...
  formdata.append("wallet_address", Acc_Number);
...
<ScrollView>
<Text style={{width:362,alignSelf:'center',textAlign:'center',color:Colors.danger,margin:5}}>Please enter amount and your vault address on which you want to recieve your payment {'Only Trust Vault'}</Text>


<Text style={{width:362,alignSelf:'center',textAlign:'left',color:Colors.FontColorI,margin:5}}>Our Withdrawal fee is <Text style={{fontWeight:"bold",fontSize:18,color:Colors.danger}}>3%</Text></Text>
<Text style={{width:362,alignSelf:'center',textAlign:'left',color:Colors.FontColorI,margin:5}}>Minimum withdraw is Rs <Text style={{fontWeight:"bold",fontSize:18,color:Colors.send}}>20$</Text></Text>
